...
namespace Microsoft.Azure.Batch.Samples.DotNetTutorial
{
    ...
    public class Program
    {
        ...
        private const string BatchAccountName = "tatslatest260417";
        private const string BatchAccountKey = "puT+Psu6aPwTVV45xlNbzA4c3FO8tYbVDbnHGRf6c6f7mTUivjV6eeL19UPRYiwMfgo3FzdsFBETEeo72q44Zg==";
        private const string BatchAccountUrl = "https://tatslatest260417.eastasia.batch.azure.com";

        // Storage account credentials
        private const string StorageAccountName = "tatslatest";
        private const string StorageAccountKey = "FuSoUKymeKFuG0rBftuUk3C8LelWyMO2Ga5m9h1rITkJfJC56BIECPo0RN8tvmc+aOiGYr6xwewOO7S2ZY+4Og==";

        private const string PoolId = "DotNetTutorialPool1";
    ...
    //                };
            ...
            foreach (ResourceFile inputFile in inputFiles)
            {
                ...
                string taskCommandLine = String.Format("cmd /c %AZ_BATCH_APP_PACKAGE_TEST1#1.0%\\TaskApplication.exe");
                //%AZ_BATCH_APP_PACKAGE_TEST1#1%\\TaskApplication.exe  // %AZ_BATCH_NODE_SHARED_DIR%\\TaskApplication.exe
